...
//     let chatGroup = await ChatGroup.findOne({ newParticipants });
//     if (!chatGroup) {
//       console.log("[POST /api/messages] Creating new ChatGroup for:", newParticipants.map((id) => id.toString()));
...
//       console.log("[POST /api/messages] ChatGroup created:", chatGroup._id.toString());
//     } else {
//       console.log("[POST /api/messages] Found existing ChatGroup:", chatGroup._id.toString());
//     }

//     // Verify chat group
//     if (!chatGroup || !chatGroup._id) {
//       console.error("[POST /api/messages] ChatGroup creation failed:", { senderId, recipientId });
//       return res.status(500).json({ error: "Failed to create or find chat group" });
//     }
...
//     console.log("[POST /api/messages] Updating lastMessage with:", {
//       senderId: senderId.toString(),
//       messageId: message._id.toString(),
//     });
//     chatGroup.lastMessage = {
//       content: message.content || (attachment ? attachment.fileName : ""),
//       senderId: new mongoose.Types.ObjectId(senderId), // Fix: Convert to ObjectId
